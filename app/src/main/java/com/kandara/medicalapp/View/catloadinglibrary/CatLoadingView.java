package com.kandara.medicalapp.View.catloadinglibrary;
...
public class CatLoadingView extends DialogFragment {
  ...
  boolean cancelleable=false;

  public void setCancelleable(boolean cancelleable) {
    this.cancelleable = cancelleable;
  }
  ...
  @Override public Dialog onCreateDialog(Bundle savedInstanceState) {
    if (mDialog == null) {
      ...
      mDialog.setCanceledOnTouchOutside(cancelleable);
